from bedevere.convolution import convolution
...
class Weapon:
    def __init__(
        self, name: str, attack_bonus: int, damage_bonus: int, damage_dice: Die
    ):
        self.name = name
...
def test():
    ...
    for condition in conditions:
        main_damage, extra_damage, Crit = weapon.attack(
            condition, extra_damage_dice=Dice([D6, D8, D8, D8])
        )
